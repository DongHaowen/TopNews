...
import com.example.oddnews.helper.OnDragVHListener;
import com.example.oddnews.helper.OnItemMoveListener;
...
public class ChannelAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements OnItemMoveListener {
    ...
    private List<Category> mMyChannelItems, mOtherChannelItems;

    // 我的频道点击事件
    private OnMyChannelItemClickListener mChannelItemClickListener;

    public ChannelAdapter(Context context, ItemTouchHelper helper, List<Category> mMyChannelItems, List<Category> mOtherChannelItems) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(final ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case TYPE_MY_CHANNEL_HEADER:
                view = mInflater.inflate(R.layout.user_channel_header, parent, false);
            ...
            case TYPE_MY:
                view = mInflater.inflate(R.layout.user_channel, parent, false);
            ...
            case TYPE_OTHER_CHANNEL_HEADER:
                view = mInflater.inflate(R.layout.other_channel_header, parent, false);
                return new RecyclerView.ViewHolder(view) {
                };

            case TYPE_OTHER:
                view = mInflater.inflate(R.layout.other_channel, parent, false);
    ...
    private void moveMyToOther(MyViewHolder myHolder) {
        ...
        Category item = mMyChannelItems.get(startPosition);
