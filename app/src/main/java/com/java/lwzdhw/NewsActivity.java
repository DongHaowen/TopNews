...
import com.java.lwzdhw.bean.MarqueeText;
import com.java.lwzdhw.bean.News;
import com.java.lwzdhw.fragment.RecommendFragment;
import com.java.lwzdhw.utils.ImageHandler;
import com.java.lwzdhw.utils.RecommendAdpter;
import com.java.lwzdhw.utils.ShareHandler;
...
//        documentView.setText("Hello World"); // Set to `true` to enable justification
    ...
    void initVideo(){
        if (!news.video.equals("")) {
            ...
            jzVideoPlayerStandard.setUp(news.video,
